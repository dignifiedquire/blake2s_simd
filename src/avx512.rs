...
unsafe fn rot12(x: __m512i) -> __m512i {
    _mm512_or_si512(_mm512_srli_epi32(x, 12), _mm512_slli_epi32(x, 20))
}
...
unsafe fn interleave128(a: __m512i, b: __m512i) -> (__m512i, __m512i) {
    (
        _mm512_permute2x128_si512(a, b, 0x20),
        _mm512_permute2x128_si512(a, b, 0x31),
    )
}

#[cfg(test)]
fn cast_out(x: __m512i) -> [u32; 8] {
...
#[inline(always)]
unsafe fn export_hashes(h_vecs: &[__m512i; 8], hash_length: u8) -> [Hash; 8] {
